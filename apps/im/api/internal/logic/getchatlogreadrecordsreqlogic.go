...
type GetChatLogReadRecordsReqLogic struct {
	logx.Logger
	ctx    context.Context
...
// 获取会话已读记录
func NewGetChatLogReadRecordsReqLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetChatLogReadRecordsReqLogic {
	return &GetChatLogReadRecordsReqLogic{
...
func (l *GetChatLogReadRecordsReqLogic) GetChatLogReadRecordsReq(req *types.GetChatLogReadRecordsReq) (resp *types.GetChatLogReadRecordsResp, err error) {
