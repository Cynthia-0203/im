...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=registry.cn-hangzhou.aliyuncs.com/g_im/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=gim-${SERVER_NAME}-${SERVER_TYPE}-test
...
build-test:
	...
	sudo docker build . -f ${DOCKER_FILE_TEST} --no-cache -t ${APP_NAME_TEST}
